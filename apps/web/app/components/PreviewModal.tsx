  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div className="flex-1 overflow-hidden flex items-center justify-center p-4">
        {isPdf && (
          <iframe src={previewUrl} className="w-full h-full rounded-xl bg-gray-100" title={previewDoc.nomeFile} />
        )}
        {isImage && (
          <img
            src={previewUrl}
        ...
        {isOfficePreviewable && (
          <iframe src={officePreviewUrl} className="w-full h-full rounded-xl bg-gray-100" title={previewDoc.nomeFile} />
        )}
        {isOfficeFallback && (
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <a href={previewUrl} download={previewDoc.nomeFile} className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 text-[#4B6E48] rounded-xl text-sm font-black uppercase tracking-widest hover:bg-slate-600/50 transition-colors shadow-lg">
