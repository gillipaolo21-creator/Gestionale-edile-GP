...
exports.FornitureServiziService = void 0;
const db_1 = require("@bresciani/db");
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let FornitureServiziService = class FornitureServiziService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async create(commessaId, dto) {
        ...
        if (!commessa) {
            throw new common_1.NotFoundException('Commessa non trovata per la fornitura servizio.');
        }
...
exports.FornitureServiziService = FornitureServiziService;
exports.FornitureServiziService = FornitureServiziService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], FornitureServiziService);
//# sourceMappingURL=forniture-servizi.service.js.map