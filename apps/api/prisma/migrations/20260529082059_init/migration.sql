...
CREATE TABLE "commesse" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "commesse_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "presenze_giornaliere" (
    ...
    CONSTRAINT "presenze_giornaliere_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "assegnazioni_mezzi" (
    ...
    CONSTRAINT "assegnazioni_mezzi_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "materiali" (
    ...
    CONSTRAINT "materiali_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "contratti_subappalto" (
    ...
    CONSTRAINT "contratti_subappalto_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "fatture" (
    ...
    CONSTRAINT "fatture_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "appalto_voci" (
    ...
    "avanzamento_percent" REAL NOT NULL DEFAULT 0,
    "costo_previsto" REAL NOT NULL DEFAULT 0,
    "costo_effettivo" REAL NOT NULL DEFAULT 0,
    "ricavo_previsto" REAL NOT NULL DEFAULT 0,
    "ricavo_effettivo" REAL NOT NULL DEFAULT 0,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "appalto_voci_commessa_id_fkey" FOREIGN KEY ("commessa_id") REFERENCES "commesse" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "appalto_voci_societa_id_fkey" FOREIGN KEY ("societa_id") REFERENCES "societa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "societa_codice_key" ON "societa"("codice");
...
-- CreateIndex
CREATE INDEX "commesse_societa_id_idx" ON "commesse"("societa_id");
...
-- CreateIndex
CREATE INDEX "presenze_giornaliere_societa_id_idx" ON "presenze_giornaliere"("societa_id");
...
-- CreateIndex
CREATE INDEX "assegnazioni_mezzi_societa_id_idx" ON "assegnazioni_mezzi"("societa_id");
...
-- CreateIndex
CREATE INDEX "materiali_societa_id_idx" ON "materiali"("societa_id");
...
-- CreateIndex
CREATE INDEX "contratti_subappalto_societa_id_idx" ON "contratti_subappalto"("societa_id");
...
-- CreateIndex
CREATE INDEX "fatture_societa_id_idx" ON "fatture"("societa_id");
...
-- CreateIndex
CREATE INDEX "appalto_voci_societa_id_idx" ON "appalto_voci"("societa_id");
